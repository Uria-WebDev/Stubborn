 ...
 */
final class Version20251126161514 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE size (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE product ADD size_id INT NOT NULL, ADD stock_id INT NOT NULL, DROP size');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD size LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', DROP size_id, DROP stock_id');
    }
}
